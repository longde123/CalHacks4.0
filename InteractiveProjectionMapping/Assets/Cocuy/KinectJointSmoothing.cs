...
public class KinectJointFilter
{
    ...
    public void Init(float fSmoothing = 0.5f, float fCorrection = 0.25f, float fPrediction = 0.25f, float fJitterRadius = 0.03f, float fMaxDeviationRadius = 0.05f)
    {
    ...
    public void Reset(float fSmoothing = 0.3f, float fCorrection = 0.25f, float fPrediction = 0.3f, float fJitterRadius = 0.05f, float fMaxDeviationRadius = 0.05f)
    {
    ...
    public void UpdateFilter(Body pBody)
    {
        ...
        m_fJitterRadius = System.Math.Max(0.0001f, m_fJitterRadius);
    ...
    {
        double x = (double)p.X * p.X + p.Y * p.Y + p.Z * p.Z;
